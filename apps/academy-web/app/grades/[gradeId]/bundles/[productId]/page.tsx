  ...
  return (
    <PublicShell active="courses">
      <div className="academy-container pb-12 pt-5 sm:pb-16 sm:pt-10">
        ...
        <section className="overflow-hidden rounded-2xl border border-border-default bg-surface shadow-[0_18px_50px_rgb(9_35_63/0.10)] sm:rounded-[2rem] sm:shadow-[0_24px_70px_rgb(9_35_63/0.10)]">
