      ...
      <section className="student-hero student-entrance px-4 py-6 sm:px-9 sm:py-8 lg:px-11">
        <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <div className="flex gap-3">
            <span className="inline-flex items-center gap-2 rounded-2xl border border-border-default bg-surface/85 px-4 py-3 text-sm font-bold shadow-sm">
      ...
      <div className="student-cover relative aspect-[16/9] overflow-hidden">
        {product.coverImageUrl ? (
          ...
          <div className="flex h-full items-center justify-center">
            <PackageOpen className="size-14 text-brand-200/60" />
          </div>
        )}
        <Badge
