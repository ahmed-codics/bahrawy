          ...
          <div className="student-cover relative aspect-video min-h-0 border-t border-border-default lg:aspect-auto lg:min-h-60 lg:border-r lg:border-t-0">
            {lessonProduct?.coverImageUrl ? (
              ...
              <div className="flex h-full items-center justify-center">
                <PlayCircle className="size-24 text-brand-200/40" />
              </div>
            )}
          </div>
        </div>
  ...
  return (
    <article className={`student-course-card relative p-5 ${!allowed ? 'opacity-90' : ''}`}>
      ...
      <div className="flex items-start gap-4">
        ...
        <span
          className={`flex size-11 shrink-0 items-center justify-center rounded-xl ${isActiveAssessment ? 'bg-warning/20 text-amber-700 dark:bg-warning/10 dark:text-amber-300' : 'bg-brand-100 text-brand-700 dark:bg-brand-950/40 dark:text-brand-200'}`}
        >
