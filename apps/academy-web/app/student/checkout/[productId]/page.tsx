    ...
    return (
      <div className="mx-auto max-w-3xl px-1 py-4 sm:py-8">
        <section className="student-hero px-4 py-8 text-center sm:px-10 sm:py-12">
          <span className="mx-auto flex size-20 items-center justify-center rounded-[1.5rem] bg-success/15 text-success">
  ...
  return (
    <section className="student-panel p-5">
      <div className="flex items-start gap-3">
        <span
          className={`flex size-11 shrink-0 items-center justify-center rounded-xl ${method === 'InstaPay' ? 'bg-amber-100 text-amber-700 dark:bg-amber-950/35 dark:text-amber-300' : 'bg-green-100 text-green-700 dark:bg-green-950/35 dark:text-green-300'}`}
        >
